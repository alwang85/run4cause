...
schema.statics.eventSuccess = function (event, cb){
  ...
  User.findOne({email: 'admin@admin.com'}, function(err, foundUser) {
    ...
    var content = 'the event you sponsored has ended! Please click here to view the details on event, and then proceed to the patients page to fulfill your promise!';
